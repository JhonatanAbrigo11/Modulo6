...
class _AddtaskpageState extends State<Addtaskpage> {
  ...
  final _anioEstrenoController = TextEditingController();
  final _vistaController = TextEditingController();
  final _fechaCompraController = TextEditingController();
              ...
              ElevatedButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    await Databasehelper().insertarPElicula(pelicula);
